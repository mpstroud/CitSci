...
AllDataSummarized_byHour.forGAM$c.hour=row.names(AllDataSummarized_byHour.forGAM) #rownames as cumulative time factor
GAM_data <- AllDataSummarized_byHour.forGAM #simplify name

gam1<- gam(temp ~ s(c.hour), data = GAM_data, method = 'REML')

gam1<- gam(temp ~ s(day, bs="cc") + s(c.hour, bs='cr',k=300), 
