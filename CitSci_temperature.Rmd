...
```{r}
setwd("C:/Users/admin/Dropbox/DRWIdataDirectory/DataInDevelopment/CitSciDeployments/EnviroDIY/sensors/04_product")
...
write.csv(tempCWF_stress,file = "C:/Users/admin/Dropbox/DRWIdataDirectory/DataInDevelopment/CitSciDeployments/EnviroDIY/sensors/04_product/tempCWF_stress.csv")
...
tempWWF_stress = combined_dataset2 %>% 
      group_by(site,year,month,day) %>%
      summarise(Tcount = sum(Tcount))
write.csv(tempWWF_stress,file = "C:/Users/admin/Dropbox/DRWIdataDirectory/DataInDevelopment/CitSciDeployments/EnviroDIY/sensors/04_product/tempWWF_stress.csv")
...
tempTSF_stress = combined_dataset2 %>% 
      group_by(site,year,month,day) %>%
      summarise(Tcount = sum(Tcount))
write.csv(tempTSF_stress,file = "C:/Users/admin/Dropbox/DRWIdataDirectory/DataInDevelopment/CitSciDeployments/EnviroDIY/sensors/04_product/tempTSF_stress.csv")
